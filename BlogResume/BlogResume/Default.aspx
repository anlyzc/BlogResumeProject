...
<head>
    ...
    <title>Anıl Yazıcı Resume</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">Anıl Yazıcı</span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="GirisYap.Aspx">Admin login</a>
                </li>
            </ul>
        </div>
    </nav>
                ...
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-5">
                            Adres: 
                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("ADRES") %>'>                      
                            </asp:Label>
                            <p></p>
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                ...
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("ALTBASLI") %>'></asp:Label>
                                </div>
                                <p>
